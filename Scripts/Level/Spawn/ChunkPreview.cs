...
{
    [Header("Settings")] [SerializeField] private Chunk[] chunkPrefabs;
    ...
    private void BuildLevel()
    {
        ...
        {
            newChunk = Instantiate(chunkPrefabs[(int) chunkTemplate.chunkType], chunkParent);
            newChunk.transform.position =
                spawnedChunks[spawnedChunks.Count - 1].end.position - newChunk.begin.localPosition;
            spawnedChunks.Add(newChunk);
            newChunk.InitializeChunk(chunkTemplate, false);
        }
